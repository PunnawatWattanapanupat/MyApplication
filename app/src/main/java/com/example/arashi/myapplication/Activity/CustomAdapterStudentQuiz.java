...
/**
 * Created by Ooppo on 28/4/2559.
 */
public class CustomAdapterStudentQuiz extends BaseAdapter {
    Context mContext;
    ArrayList<Question> questionData;

    public CustomAdapterStudentQuiz(Context context, ArrayList<Question> questionData) {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        if (view == null)
            view = mInflater.inflate(R.layout.listview_student_quiz, parent, false);
