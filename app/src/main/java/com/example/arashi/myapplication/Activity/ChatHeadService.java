...
//import com.example.arashi.myapplication.Activity.ChatHeadActivity;
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        iconView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.e("Abstract", "DONE");
                //startActivity(new Intent(ChatHeadService.this,MainActivity.class));

                Intent myIntent = new Intent(ChatHeadService.this, ClassActivity.class);
